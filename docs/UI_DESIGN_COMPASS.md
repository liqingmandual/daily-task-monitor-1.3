...
- A productivity score must not become the product's moral judgement of the
  user. Orbit should explain evidence and uncertainty.
...
- Planets are Mole's product metaphor. Orbit needs its own language.
...
- Is this recognizably Orbit rather than a copy of Rize or Mole?
