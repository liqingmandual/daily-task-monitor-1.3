...
const workbenchPayload: TrendWorkbenchPayload = {
  ...
  buckets: [{
    ...
    drilldown: {
      ...
      completedTasks: [{ taskId: "task-1", taskTitle: "实现趋势工作台", projectId: "project-1", projectName: "Orbit", completedAtMs: 1_752_000_000_000 }],
      linkedTaskRollups: [{ taskId: "task-1", taskTitle: "实现趋势工作台", projectId: "project-1", projectName: "Orbit", linkedSeconds: 3_600, activitySeconds: 3_600, focusSeconds: 900, evidenceCount: 2, sharedEvidenceCount: 1 }],
      linkedProjectRollups: [{ projectId: "project-1", projectName: "Orbit", linkedSeconds: 3_600, activitySeconds: 3_600, focusSeconds: 900, evidenceCount: 2, sharedEvidenceCount: 1 }],
      workflowOwnership: [{ ownershipId: "owner-1", evidenceKind: "activity", evidenceId: "activity-1", taskId: "task-1", taskTitle: "实现趋势工作台", projectId: "project-1", projectName: "Orbit", shared: true }],
